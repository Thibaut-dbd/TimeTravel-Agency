...
export function ChatbotWidget() {
  ...
  const handleSend = async () => {
    ...
    // -------------------------------------------------------
    // API HOOK: Replace this simulated response with your
    // actual API call (e.g., fetch('/api/chat', { ... }))
    // -------------------------------------------------------
    setTimeout(() => {
      const botResponse: Message = {
        ...
        role: "assistant",
        content:
          "Merci pour votre question ! Notre \u00E9quipe temporelle est en train d'analyser votre demande. Ce chatbot sera bient\u00F4t connect\u00E9 \u00E0 notre IA pour vous fournir des r\u00E9ponses personnalis\u00E9es sur nos voyages dans le temps.",
        timestamp: new Date(),
      }
